#### These are some really basic python programs that I had built for my practical exams. They can be really useful to beginners.

Here are some useful links, check them out:
  - [Iterators](https://docs.python.org/3/tutorial/classes.html#iterators) 
  - [Iterables](https://realpython.com/python-iterators-iterables/#working-with-iterables-in-python) 
